...
<body class="overflow-x-hidden">
    ...
    <section class="flex font-orkney justify-between">
        ...
        <div class="flex justify-center p-5 items-center w-full">
                ...
                <div class="flex flex-col gap-5 items-center">
                    ...
                    <div class="flex gap-20">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="name" value="{{ $customer->name }}">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="exampleInputEmail1">Email</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="email" value="{{ $customer->email }}">
                        </div>
                    </div>
                    <div class="flex gap-20">
                        <div class="flex flex-col gap-2">
                            <label for="exampleInputEmail1">Address</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="address" value="{{ $customer->address }}">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="exampleInputEmail1">Age</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="age" value="{{ $customer->email }}">
                        </div>
                    </div>
                    <div class="flex gap-20">
                        <div class="flex flex-col gap-2">
                            <label for="exampleInputEmail1">Number</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="number" value="{{ $customer->number }}">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="exampleInputEmail1">Payment</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="payment" value="{{ $customer->payment }}">
                        </div>
                    </div>
                    <div class="flex gap-20">
                        <div class="flex flex-col gap-2   ">
                            <label for="exampleInputEmail1">Delivery</label>
                            <input type="text" class=" bg-gray-100 border-gray-300 px-5 py-3 opacity-90 w-[300px] placeholder:text-[12px]" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" name="delivery" value="{{ $customer->delivery }}">
                        </div>
                    </div>

                    <button type="submit" class="border text-center border-primary border-opacity-50 px-4 py-2 hover:text-black hover:border-opacity-80 hover:bg-primary hover:bg-opacity-10">Submit</button>
                </div>
            </form>
        </div>
    </section>
