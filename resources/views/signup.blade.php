...
<body>
    <div id="signup-popup" tabindex="-1" class="bg-black/50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 h-full items-center justify-center flex">
                ...
                <div class="p-5">
                    ...
                    <div class="text-center">
                        ...
                        <form class="w-full">
                            ...
                            <button type="submit" class="mt-2 inline-flex w-full items-center justify-center  bg-black p-2 py-3 text-sm font-medium text-white outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:bg-gray-400">
                                Continue
                            </button>
                        </form>
                    ...
                    <div class="mt-6 text-center text-sm text-slate-600">
                        Have an account?
                        <a href="/login" class="font-medium text-[#4285f4]">Login</a>
                    </div>
                </div>
            </div>
        </div>
